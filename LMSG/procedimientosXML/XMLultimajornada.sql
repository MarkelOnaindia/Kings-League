...
CREATE OR REPLACE PROCEDURE generar_xml_ultimajornada AS
...
BEGIN
  ...
  DBMS_XMLGEN.setRowSetTag(qryCtx, 'UltimaJornadas');
  ...
  INSERT INTO CAL_XML_RESULTADOS VALUES(DEFAULT, result,fecha_expiracion, 'UltimaJornadas');
