...
public class TEntrenador {
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("delete from Entrenadores where IdEnt = ?");
        ps.setInt(1, e.getIdEnt());
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("update Entrenadores set DNI = ?, Nombre = ?, Apellido1 = ?, Apellido2 = ?, Telefono = ?, Correo = ? where IdEnt = ?");
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("select * from Entrenadores where IdEnt = ?");
        ps.setInt(1, e.getIdEnt());
