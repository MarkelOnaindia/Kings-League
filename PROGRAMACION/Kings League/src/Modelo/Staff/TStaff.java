...
public class TStaff {
    ...
    public static void insertar(Staff stf) throws Exception
    {
        ...
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("insert into Staff values (?,?,?,?,?,?,?,?)");
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("delete from Staff where IdStaff = ?");
        ps.setInt(1, stf.getIdStaff());
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("update Staff set DNI = ?, Nombre = ?, Apellido1 = ?, Apellido2 = ?, Telefono = ?, Correo = ?, Rol = ?  where IdStaff = ?");
    ...
    {
        BaseDatos.abrirConexion();
        PreparedStatement ps = BaseDatos.getCon().prepareStatement("select * from Staff where IdStaff = ?");
        ps.setInt(1, stf.getIdStaff());
