...
public class vActualizarContratoDueno {
    ...
    public static void main(String[] args) {
        ...
        frame.setContentPane(new vActualizarContratoDueno().pPrincipal);
    ...
    //Todo
    public vActualizarContratoDueno() {
        ...
        insertarButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int idPro = Main.stringAInt(tfIDPro.getText());
    ...
    public void valores(){
        ...
        try {
            ...
            String np = Main.nombrePropietario(tfIDPro.getText());
            String ne = Main.nombreEquipo(tfIDEquipo.getText());

            tfIDEquipo.setText(String.valueOf(cd1.getEquipo().getIdEquipo()));
            tfIDPro.setText(String.valueOf(cd1.getPropietario().getIdPro()));
